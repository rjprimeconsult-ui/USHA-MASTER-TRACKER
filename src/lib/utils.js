...
// Moved to lib/datetimeField.mjs (2026-07-28) so it sits on the `node --test`
// lane: it carries a timezone trap that silently shifted date-only values
// back a day, and utils.js can't be unit-tested (extensionless import of
// './constants'). Re-exported here so existing callers are unaffected.
export { toDateTimeLocalInput } from './datetimeField.mjs';
