...
const STEPS = [
  {
    ...
    body: 'A quick tour of every tab and the newest tools — then we\'ll try Smart Import on a real file of yours. Skip if you\'ve been here before.',
    icon: Sparkles,
  ...
  },
  {
    ...
    body: 'Ask anything in English or Spanish. It knows the app, reads your data for specific answers, and can jump you straight to any tab — help is always one click away.',
    icon: MessageCircle,
  ...
  },
  {
    ...
    body: 'True cost-per-deal, weekly performance, deal counts, platform spend and chargebacks — all updating automatically as you log leads and expenses.',
    icon: Gauge,
  ...
  },
  {
    id: 'closed',
    title: 'Closed Deals',
    tagline: 'Every outcome, not just the wins.',
    body: 'Issued, Declined, Not-taken and Withdrawn in one tracker, with breakdowns by CRM source, category and campaign. Statement matches land your commissions here.',
    icon: CheckSquare,
  ...
  },
  {
    ...
    tagline: 'Your full book of business.',
    body: 'Every client, plan, premium and renewal in one searchable table — filter by stage, product, month or age, bulk-edit, and spot repeat clients automatically.',
    icon: Users,
    iconBg: 'bg-blue-100 text-blue-700',
    cta: { label: 'Open Portal Clients', action: 'navigate', viewId: 'leads' },
  },
  {
    id: 'prospects',
    title: 'Prospects',
    tagline: 'Your pre-deal pipeline.',
    body: 'Work leads before they close. A single "Needs a touch" list surfaces every follow-up due — log a call, text or email and it clears itself.',
    bullets: [
      'Leads auto-create from Ringy, TextDrip and Benepath — they flow in by themselves.',
      'Smart Import a CRM screenshot and AI fills in the prospect for you.',
      'Send outreach emails and track every touch on a timeline.',
    ],
    icon: UserPlus,
  ...
  },
  {
    ...
    body: 'Income, expenses and net — with Smart Import (AI): drop any bank statement (PDF, CSV, Excel, even several at once) and it categorizes every line. Platform charges live here too.',
    icon: BookOpen,
  ...
  },
  {
    ...
    body: 'A spend dashboard for your CRM tools — what really drives your True CPA. You log the charges in Books; this is the visual rollup feeding your cost-per-deal.',
    icon: DollarSign,
  ...
  },
  {
    id: 'reports',
    title: 'Reports',
    tagline: 'Numbers ready to share.',
    body: 'Five clean reports — Leads Sold, Overrides, Chargebacks, Expenses vs budget, and a P&L summary — with this-month / last-month / YTD presets or any custom range. Print-ready.',
    icon: BarChart3,
    iconBg: 'bg-teal-100 text-teal-700',
    cta: { label: 'Open Reports', action: 'navigate', viewId: 'reports' },
  },
  {
    id: 'other-views',
    title: 'Overview · Associations · Pipeline',
    tagline: 'More angles on your book.',
    body: 'Three more views worth knowing:',
    bullets: [
      'Overview — counts, close rate and revenue by month at a glance.',
      'Associations — your residual book by USHA tier, quarterly earned and renewals.',
      'Pipeline — drag-and-drop kanban of leads by stage.',
      'Team leaders also get View My Team — a live scoreboard and read-only view of their downline.',
    ],
  ...
  },
  {
    ...
    body: 'Compare WA / CA / FTA / FSL rates side by side for any product and state, split commissions, and prefill from a screenshot. It never touches your real data.',
    icon: Calculator,
  ...
  },
  {
    ...
    body: 'Drop USHA weekly advances or monthly payouts and PRIM auto-matches every commission row to the right deal — even when USHA pays under a spouse\'s name.',
    icon: Upload,
  ...
  },
  {
    ...
    body: 'Drop your existing tracker — Excel, PDF, USHA export, even a screenshot. It runs in preview, so nothing saves until you confirm.',
    icon: Sparkles,
